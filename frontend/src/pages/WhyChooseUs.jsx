          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="aspect-square rounded-3xl bg-gradient-to-br from-[#ef4444] via-red-500 to-orange-500 p-8 flex items-center justify-center shadow-2xl">
                  <div className="text-white text-center">
                    <div className="text-6xl font-bold mb-2">500+</div>
                    <div className="text-xl opacity-90">Happy Salons</div>
                  </div>
                </div>
              ...
              <div className="relative p-8 md:p-10">
                <div className="flex flex-col md:flex-row items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 group-hover:text-[#ef4444] transition-colors">
                      {benefit.title}
                    </h2>
