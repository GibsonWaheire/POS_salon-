          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="aspect-square rounded-3xl bg-gradient-to-br from-green-500 via-emerald-500 to-teal-500 p-8 flex items-center justify-center shadow-2xl">
                  <DollarSign className="h-32 w-32 text-white opacity-80" />
                </div>
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 max-w-6xl">
        <div className="space-y-16">
          ...
          <section className="bg-white rounded-3xl p-10 shadow-lg border border-gray-100">
            ...
            <p className="text-lg text-gray-700 mb-8">All plans include:</p>
          ...
          <section className="bg-white rounded-3xl p-10 shadow-lg border border-gray-100">
            <div className="flex items-start gap-6">
              ...
              <div>
                <h2 className="text-4xl font-bold text-gray-900 mb-6">Custom Enterprise Plans</h2>
                <p className="text-lg text-gray-700 leading-relaxed">
          ...
          <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#ef4444] via-red-600 to-red-700 p-12 text-white">
            ...
            <div className="relative z-10">
              <div className="flex items-start gap-6 mb-6">
                ...
                <div>
                  <h2 className="text-4xl font-bold mb-4">Free Trial</h2>
          ...
          <section className="bg-white rounded-3xl p-10 shadow-lg border border-gray-100 text-center">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Get a Custom Quote</h2>
